...
class ContactFormHandler {
    ...
    showLoading(show) {
        ...
        if (show) {
            ...
            submitBtn.innerHTML = languageManager.currentLang === 'zh' ? '发送中...' : 'Sending...';
        } else {
            submitBtn.disabled = false;
            submitBtn.innerHTML = languageManager.currentLang === 'zh' ? '发送消息' : 'Send Message';
        }
    }

    showSuccess() {
        const successMsg = languageManager.currentLang === 'zh' ? 
            '消息发送成功！我会尽快回复您。' : 
